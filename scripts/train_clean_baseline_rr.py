"""Train the clean ECG + RR baseline model."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Train the clean ECG + RR baseline."
    )
...
def main() -> None:
    ...
    print("=" * 72)
    print("CLEAN ECG + RR BASELINE TRAINING")
    print("=" * 72)
    ...
    print(
        "\nBuilding training ECG + RR dataset..."
    )
    ...
    print(
        "Building validation ECG + RR dataset..."
    )
    ...
    # ---------------------------------------------------------
    # 3. Fit RR normalization on TRAIN ONLY
    # ---------------------------------------------------------
    ...
    print("\nTraining RR normalization statistics:")
